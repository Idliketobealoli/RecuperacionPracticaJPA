...
object CommitController {
    ...
    private fun findAllCommitsJSON(): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.findAllCommits()) ?: throw SQLException("Error at CommitController.findAllCommitsJSON")
    }
    ...
    private fun insertCommitJSON(dto: CommitDTO): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.createCommit(dto)) ?: throw SQLException("Error at CommitController.insertCommitJSON:" +
    ...
    private fun updateCommitJSON(dto: CommitDTO): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.updateCommit(dto)) ?: throw SQLException("Error at CommitController.updateCommitJSON:" +
    ...
    private fun deleteCommitJSON(dto: CommitDTO): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.deleteCommit(dto)) ?: throw SQLException("Error at CommitController.deleteCommitJSON:" +
