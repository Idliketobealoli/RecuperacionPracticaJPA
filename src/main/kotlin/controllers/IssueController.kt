...
object IssueController {
    ...
    private fun findAllIssueJSON(): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.getAllIssues()) ?: throw SQLException("Error at IssueController.findAllIssuesJSON")
    }
    ...
    private fun getIssueByIdJSON(id: String): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.getIssueById(id)) ?: throw SQLException("Error at IssueController.getIssueByIdJSON:" +
    ...
    private fun insertIssueJSON(dto: IssueDTO): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.createIssue(dto)) ?: throw SQLException("Error at IssueController.insertIssueJSON:" +
    ...
    private fun updateIssueJSON(dto: IssueDTO): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.updateIssue(dto)) ?: throw SQLException("Error at IssueController.updateIssueJSON:" +
    ...
    private fun deleteIssueJSON(dto: IssueDTO): String {
        return GsonBuilder().setPrettyPrinting().create()
                .toJson(service.deleteIssue(dto)) ?: throw SQLException("Error at IssueController.deleteIssueJSON:" +
